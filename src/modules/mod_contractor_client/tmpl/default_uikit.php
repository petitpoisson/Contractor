...
?>
<div class="mod-contractor-client com-contractor-client-view uk-margin-top <?php echo htmlspecialchars($moduleClass, ENT_QUOTES, 'UTF-8'); ?>">
    <?php if ($is_guest): ?>
        <div class="uk-alert uk-border-rounded-1 uk-padding-small" uk-alert>
            <a href="<?php echo htmlspecialchars($login_url, ENT_QUOTES, 'UTF-8'); ?>" class="uk-button uk-button-default uk-border-rounded-1 uk-float-right uk-margin-small-top">
                <?php echo Text::_('JLOGIN'); ?>
            </a>
            <h4 class="uk-margin-remove uk-padding-small"><span uk-icon="icon: lock"></span> <?php echo Text::_('JGLOBAL_YOU_MUST_LOGIN_FIRST'); ?></h4>
        </div>
                ...
                ?>
                    ...
                    <li class="uk-card uk-card-default uk-card-small uk-margin-small-bottom uk-border-rounded-0">
                        <a class="uk-accordion-title custom-uikit-contract-bg custom-uikit-padding uk-flex uk-flex-middle" href="#">
                            ...
                            <span class="uk-text-uppercase uk-text-bold uk-width-expand"><?php echo htmlspecialchars($contract->name, ENT_QUOTES, 'UTF-8'); ?></span>
                                ...
                                <ul class="uk-list uk-list-divider uk-margin-remove-top uk-margin-remove-bottom">
                                    <?php foreach ($contract->lines as $line): ?>
                                        <li class="uk-flex uk-flex-between uk-flex-middle custom-uikit-padding-lines">
                                            <span class="uk-text-muted"><?php echo htmlspecialchars($line->description, ENT_QUOTES, 'UTF-8'); ?></span>
            ...
            <?php if ($showInvoicesSw): ?>
                <li class="uk-card uk-card-default uk-card-small uk-margin-small-bottom uk-border-rounded-0">
                    <a class="uk-accordion-title custom-uikit-invoice-bg custom-uikit-padding uk-flex uk-flex-middle" href="#">
                        ...
                        <span class="uk-label uk-border-rounded-0"><?php echo count($invoices)." ".Text::_('COM_CONTRACTOR_CLIENT_INVOICES_TITLE'); ?></span>
                    </a>
                    <div class="uk-accordion-content uk-margin-remove-top">
                        <div class="custom-uikit-padding-lines">
                            <?php if ($hasInvoices): ?>
                                ...
                                <ul class="uk-list uk-list-divider">
                                    <?php foreach ($invoices as $invoice): ?>
                                        <li class="uk-flex">
                                            <span class="uk-text-muted uk-margin-large-right"><?php echo htmlspecialchars($invoice->invoicedate, ENT_QUOTES, 'UTF-8'); ?></span>
                                            <a class="uk-link-reset" href="<?php echo htmlspecialchars($invoice->pdf_link, ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><?php echo htmlspecialchars($invoice->reference, ENT_QUOTES, 'UTF-8'); ?> 
