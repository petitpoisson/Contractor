...
namespace XavierSpirlet\Component\Contractor\Administrator\View\Clients;
...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        if (!$user->authorise('core.manage.clients', 'com_contractor')) {
    ...
    {
        ToolbarHelper::title(\Joomla\CMS\Language\Text::_('COM_CONTRACTOR_CLIENTSLIST_TITLE'), 'users');
